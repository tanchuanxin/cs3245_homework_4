...
ss = nltk.stem.snowball.SnowballStemmer(language='english')
...
class Clean:
    ...
    def americanize(self, text):
        for british_spelling, american_spelling in self.gb2us.items():
            text = text.replace(british_spelling, american_spelling)
    ...
    def remove_punctuations(self, text):
        # Remove punctuations
        text = [w.translate(str.maketrans('', '', string.punctuation))
                for w in text]
